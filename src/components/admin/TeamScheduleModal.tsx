...
export default function TeamScheduleModal({ memberId, memberName, isOpen, onClose }: TeamScheduleModalProps) {
        ...
        <>
            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
                    {/* Header */}
                    <div className="flex items-center justify-between p-5 border-b border-primary/10 bg-primary/5">
                            ...
                            <div className="space-y-2">
                                {DAYS.map((day) => {
                                    ...
                                    return (
                                        <div
                                            key={day.value}
                                            className={`p-3 rounded-xl border transition-all ${sched.is_available
                                        ...
                                        >
                                            ...
                                            {/* Row 2: Time range (only when available) */}
                                            {sched.is_available && (
                                                <div className="flex items-center gap-2 mt-2.5 pl-12">
                                                    ...
                                                    <input
                                                        ...
                                                        className="flex-1 min-w-0 px-2 py-1 text-xs border border-primary/20 rounded-lg focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary bg-white"
                                                    />
                    ...
                    {/* Footer */}
                    <div className="p-5 border-t border-primary/10 bg-white flex items-center justify-between gap-3">
