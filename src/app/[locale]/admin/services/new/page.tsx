...
import { ChevronLeft, Info, FileText, HandCoins, Users, Activity, Check } from "lucide-react";
        ...
        <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="relative bg-white border border-primary/10 rounded-[40px] shadow-sm overflow-hidden translate-z-0">
                <div className="relative p-6 border-b border-primary/10 bg-primary/5 flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-black text-primary tracking-tight">Add New Service</h1>
                        <p className="text-sm text-tertiary font-medium">Define the details and pricing for your new offering.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="relative p-8 space-y-12">
                    ...
                    <div className="space-y-6">
                        ...
                        {loadingTeamMembers ? (
                            ...
                            <div className="p-8 rounded-2xl bg-background border-2 border-dashed border-primary/10 text-center">
                                <Users className="w-8 h-8 text-primary/20 mx-auto mb-2" />
                                <p className="text-xs text-tertiary font-medium">No team members found yet.</p>
                            </div>
                        ) : (
                        ...
                        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="space-y-2">
                                ...
                                <p className="text-sm text-white/70 font-medium max-w-sm">
                                    Optionally start this service as paused. Clients won't be able to book it online until you activate it.
                                </p>
                            </div>
                            ...
                            <label className="relative flex items-center cursor-pointer">
                                ...
                                <div className="ml-4 flex flex-col">
                                    <span className="text-lg font-black uppercase tracking-widest leading-none peer-checked:text-emerald-400">
                                        Paused?
                                    </span>
                                </div>
                            </label>
